...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.model = X_Layer(self.seq_len, self.pred_len, self.e_layers, self.layers_num, self.hidden_channels, self.out_channels, self.stride1, self.stride2, self.stride3,
